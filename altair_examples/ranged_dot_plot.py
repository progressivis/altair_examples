...
chart = (
    ...
    .transform_filter(filter={"field": "year", "oneOf": [1955, 2000]})
)

chart += (
    alt.Chart()
    .mark_line(color="#db646f")
    .encode(x="life_expect:Q", y="country:N", detail="country:N")
)
...
chart += (
    ...
    .encode(
        ...
        color=alt.Color(
            "year:O",
            scale=alt.Scale(
                domain=["1955", "2000"], range=["#e6959c", "#911a24"]
            ),
        ),
    )
    .interactive()
